...
export default class QrCode extends Component {
  ...
  setRef = (ctx, value) => {
    ...
    var fgColor = this.props.foreground === undefined ? '#000000' : this.props.foreground;
    var bgColor = this.props.background === undefined ? '#FFFFFF' : this.props.background;
    var margin = this.props.margin === undefined ? 10 : parseInt(this.props.margin);
